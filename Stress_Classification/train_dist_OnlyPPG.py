...
from train_func import train_PPG_model
...
parser.add_argument("--config_path", type=str, default='./config/VGG16_OnlyPPG.json', help="config path")
...
def main_worker(rank, world_size):
    ...
    # Learning
    train_PPG_model(model=cls_model,
